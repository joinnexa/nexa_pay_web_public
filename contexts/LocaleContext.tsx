...
const translations = {
  ...
  fr: {
    ...
    form: {
      ...
      userTypeConsumer: "Consommateur",
      userTypeMerchant: "Commercant",
  ...
  ar: {
    ...
    form: {
      ...
      userTypeConsumer: "مستهلك",
      userTypeMerchant: "تاجر",
      userTypeInvestor: "مستثمر",
