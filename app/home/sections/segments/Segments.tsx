...
export const SegmentsSection = () => {
  ...
  return (
    <section id="segments" className="bg-gray-50 dark:bg-[#070f1f] py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-10">
          ...
          {t.segments.cards.map((card, index) => {
            ...
            return (
              <ScrollStagger key={card.title} index={index}>
                <article className="h-full rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#101b31] p-5 md:p-6 shadow-sm">
